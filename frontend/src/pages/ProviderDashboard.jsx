              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {myServices.map(service => (
                    ...
                    >
                      <img src={getImageUrl(service.image)} alt={service.title} className="w-full h-48 object-cover opacity-60 group-hover:opacity-100 transition-opacity" />
                      <div className="p-8">
                ...
                <div className="space-y-8 bg-white/5 p-10 rounded-[3rem] border border-white/10 backdrop-blur-3xl relative overflow-hidden">
                   ...
                   {profileData.image && (
                      <div className="absolute top-0 right-0 w-64 h-64 opacity-10 pointer-events-none">
                         <img src={getImageUrl(profileData.image)} alt="Profile Glow" className="w-full h-full object-cover blur-3xl" />
                      </div>
                   )}
                   ...
                   <div className="space-y-3">
                     ...
                     <div className="flex flex-col sm:flex-row gap-6 items-center">
                        <div className="w-32 h-32 rounded-3xl bg-white/5 border border-white/10 overflow-hidden flex items-center justify-center relative group">
                           {profileData.image ? (
                              <img src={getImageUrl(profileData.image)} alt="Profile" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                           ) : (
                 ...
                 <div className="space-y-2">
                   ...
                   <div className="flex gap-6 items-center">
                        <div className="w-24 h-24 rounded-2xl bg-white/5 border border-white/10 overflow-hidden flex items-center justify-center relative">
                           {newService.image ? (
                              <img src={getImageUrl(newService.image)} alt="Service Showcase" className="w-full h-full object-cover" />
                           ) : (
